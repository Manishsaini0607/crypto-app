  ...
  return (
   <main className='flex h-screen w-full bg-[#F5F7FA]' >  
       <div className=' text-center m-auto p-8 rounded-2xl bg-white shadow-md max-w-[450px] '>
           ...
           <p className="text-xs text-[#797E82]  ">We have sent instructions on how to reset your password to <span className='font-medium'>jenny.wilson@gmail.com</span>. Please follow the instructions from the email.</p>
